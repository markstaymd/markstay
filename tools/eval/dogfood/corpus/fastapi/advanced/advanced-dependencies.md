...
<!-- stay:aiat9x9z hash=sha256:582d17ccfaa5 -->

## Parameterized dependencies { #parameterized-dependencies }
<!-- stay:5yzrra46 hash=sha256:740a341f6ec8 -->

All the dependencies we have seen are a fixed function or class.
<!-- stay:o1QgbpjE hash=sha256:23be9e1691bb -->

But there could be cases where you want to be able to set parameters on the dependency, without having to declare many different functions or classes.
<!-- stay:u61YLwbs hash=sha256:073b92383f95 -->

Let's imagine that we want to have a dependency that checks if the query parameter `q` contains some fixed content.
<!-- stay:fy9tJtTM hash=sha256:833db0a57376 -->

But we want to be able to parameterize that fixed content.
<!-- stay:RhQQXX9F hash=sha256:23a4ab710baf -->

## A "callable" instance { #a-callable-instance }
<!-- stay:UXeugknU hash=sha256:b2ffdb61afae -->

In Python there's a way to make an instance of a class a "callable".
<!-- stay:KiyncYrk hash=sha256:4dfaee052b08 -->

Not the class itself (which is already a callable), but an instance of that class.
<!-- stay:hJzgMkzO hash=sha256:de9fee52b5dc -->

To do that, we declare a method `__call__`:
<!-- stay:iznjG6IN hash=sha256:4f36986531ef -->

{* ../../docs_src/dependencies/tutorial011_an_py310.py hl[12] *}
<!-- stay:AWKiCB0v hash=sha256:6279286fa709 -->

In this case, this `__call__` is what **FastAPI** will use to check for additional parameters and sub-dependencies, and this is what will be called to pass a value to the parameter in your *path operation function* later.
<!-- stay:DZGPambn hash=sha256:bf6a7592e965 -->

## Parameterize the instance { #parameterize-the-instance }
<!-- stay:VEwHMILf hash=sha256:965dc2743187 -->

And now, we can use `__init__` to declare the parameters of the instance that we can use to "parameterize" the dependency:
<!-- stay:mmlt8jwy hash=sha256:5190e35dbc69 -->

{* ../../docs_src/dependencies/tutorial011_an_py310.py hl[9] *}
<!-- stay:NHvmaM0U hash=sha256:efb49f03d7dc -->

In this case, **FastAPI** won't ever touch or care about `__init__`, we will use it directly in our code.
<!-- stay:NoXbISzG hash=sha256:5378b6994f1c -->

## Create an instance { #create-an-instance }
<!-- stay:yrR1HISe hash=sha256:08e2f9cb2b9e -->

We could create an instance of this class with:
<!-- stay:26mCEwnc hash=sha256:56a557b8ac8a -->

{* ../../docs_src/dependencies/tutorial011_an_py310.py hl[18] *}
<!-- stay:RkIk7jOJ hash=sha256:fd4eb07020d5 -->

And that way we are able to "parameterize" our dependency, that now has `"bar"` inside of it, as the attribute `checker.fixed_content`.
<!-- stay:sHsy5hsL hash=sha256:6e98f4486c24 -->

## Use the instance as a dependency { #use-the-instance-as-a-dependency }
<!-- stay:pWMz4VCU hash=sha256:b8ecf5fced83 -->

Then, we could use this `checker` in a `Depends(checker)`, instead of `Depends(FixedContentQueryChecker)`, because the dependency is the instance, `checker`, not the class itself.
<!-- stay:thZbH4sL hash=sha256:8b8586ed3fb7 -->

And when solving the dependency, **FastAPI** will call this `checker` like:
<!-- stay:hMQONPFg hash=sha256:ed69c5aad702 -->

```Python
checker(q="somequery")
```
<!-- stay:UeGRd3Vv hash=sha256:b57004afd056 -->

...and pass whatever that returns as the value of the dependency in our *path operation function* as the parameter `fixed_content_included`:
<!-- stay:7f1Ehg7T hash=sha256:def082a0348c -->

{* ../../docs_src/dependencies/tutorial011_an_py310.py hl[22] *}
<!-- stay:w5e7YmZt hash=sha256:c9f0bbd34622 -->

/// tip
<!-- stay:bFpnTWqL hash=sha256:35fc886a93b5 -->

All this might seem contrived. And it might not be very clear how it is useful yet.
<!-- stay:GrH0dR1k hash=sha256:1f35efd2083a -->

These examples are intentionally simple, but show how it all works.
<!-- stay:xRz7NMuU hash=sha256:b89f05e1962d -->

In the chapters about security, there are utility functions that are implemented in this same way.
<!-- stay:BDFtNg3L hash=sha256:c8eaac66c763 -->

If you understood all this, you already know how those utility tools for security work underneath.
<!-- stay:oN3J4RlK hash=sha256:91f75bb5f81b -->

///
<!-- stay:Bm2w0kDv hash=sha256:732c4e971163 -->
...
<!-- stay:bkcH5KTS hash=sha256:4a0e66a37e43 -->

/// warning
<!-- stay:7pBdvm0h hash=sha256:98e5a9621bab -->

You most probably don't need these technical details.
<!-- stay:GMN44IYX hash=sha256:3a960c3f7e0b -->
...
<!-- stay:4HdXUmPb hash=sha256:18f5827e0471 -->

///
<!-- stay:1eVo1sNE hash=sha256:732c4e971163 -->
...
<!-- stay:aaD2qkfQ hash=sha256:8efc6e4c3d93 -->
...
<!-- stay:rOmB6qGe hash=sha256:d0bdc845202c -->

Before FastAPI 0.118.0, if you used a dependency with `yield`, it would run the exit code after the *path operation function* returned but right before sending the response.
<!-- stay:dqBox9xV hash=sha256:8b54eb0f61f6 -->
...
<!-- stay:QsGbEtcE hash=sha256:6e4f513a917a -->

This change also meant that if you returned a `StreamingResponse`, the exit code of the dependency with `yield` would have been already run.
<!-- stay:ghyGhJyw hash=sha256:0e0a91891a25 -->

For example, if you had a database session in a dependency with `yield`, the `StreamingResponse` would not be able to use that session while streaming data because the session would have already been closed in the exit code after `yield`.
<!-- stay:zVYn39qT hash=sha256:a495987558b9 -->

This behavior was reverted in 0.118.0, to make the exit code after `yield` be executed after the response is sent.
<!-- stay:tF4gxAgG hash=sha256:ff327fb9327c -->

/// note
<!-- stay:47Lix65L hash=sha256:35f4d438b538 -->
...
<!-- stay:7BzxdHXp hash=sha256:97a0d636465c -->

///
<!-- stay:6rVHTOlt hash=sha256:732c4e971163 -->

#### Use Cases with Early Exit Code { #use-cases-with-early-exit-code }
<!-- stay:bvqcJ4xx hash=sha256:d6865187e4f5 -->
...
<!-- stay:PEyyztE6 hash=sha256:d9b393334414 -->
...
<!-- stay:EWhZmmO0 hash=sha256:8710800a6c39 -->
...
<!-- stay:75q4akb6 hash=sha256:4e8ae2f453da -->

Here's how it could look:
<!-- stay:looAxeZn hash=sha256:c07f6667c078 -->

{* ../../docs_src/dependencies/tutorial013_an_py310.py *}
<!-- stay:M0ED9odr hash=sha256:781282617692 -->

The exit code, the automatic closing of the `Session` in:
<!-- stay:RQyMnwkL hash=sha256:12468db44a1c -->

{* ../../docs_src/dependencies/tutorial013_an_py310.py ln[19:21] *}
<!-- stay:T2IRea7o hash=sha256:148e96515c68 -->

...would be run after the response finishes sending the slow data:
<!-- stay:QYhYHyhK hash=sha256:b93d98f5f416 -->

{* ../../docs_src/dependencies/tutorial013_an_py310.py ln[30:38] hl[31:33] *}
<!-- stay:EWj0wcx6 hash=sha256:c4ca0e0c4d82 -->
...
<!-- stay:zhL86hPh hash=sha256:bfa5a5202d9e -->
...
<!-- stay:TjbJJ7QR hash=sha256:5aaeace85fdc -->

{* ../../docs_src/dependencies/tutorial014_an_py310.py ln[24:28] hl[28] *}
<!-- stay:6L2FBDUj hash=sha256:7f020f78ffb8 -->

That way the session would release the database connection, so other requests could use it.
<!-- stay:Ybxn0l38 hash=sha256:391b09bad7e6 -->
...
<!-- stay:pixrEarm hash=sha256:90272d495ed9 -->
...
<!-- stay:6CBpCYLX hash=sha256:d89d04dd89de -->
...
<!-- stay:56uRoGSr hash=sha256:d814283f4c6c -->

This was designed this way mainly to allow using the same objects "yielded" by dependencies inside of background tasks, because the exit code would be executed after the background tasks were finished.
<!-- stay:VR7fRfPG hash=sha256:d930ea8a6d98 -->
...
<!-- stay:whn39ssP hash=sha256:74da764e60ab -->

/// tip
<!-- stay:sR5DtYbD hash=sha256:35fc886a93b5 -->

Additionally, a background task is normally an independent set of logic that should be handled separately, with its own resources (e.g. its own database connection).
<!-- stay:eUJNVlSJ hash=sha256:d64a6de3a9d9 -->

So, this way you will probably have cleaner code.
<!-- stay:cIAOF2WN hash=sha256:e36868ee95e6 -->

///
<!-- stay:w06MGfFg hash=sha256:732c4e971163 -->

If you used to rely on this behavior, now you should create the resources for background tasks inside the background task itself, and use internally only data that doesn't depend on the resources of dependencies with `yield`.
<!-- stay:cwXdcoe5 hash=sha256:6cf6262dd0de -->

For example, instead of using the same database session, you would create a new database session inside of the background task, and you would obtain the objects from the database using this new session. And then instead of passing the object from the database as a parameter to the background task function, you would pass the ID of that object and then obtain the object again inside the background task function.
<!-- stay:inTb0OVn hash=sha256:e5ef7a99574d -->
