...
<!-- stay:dY5xycJF hash=sha256:09703775a123 -->

With this new knowledge about iterators, we can improve the I/O project in
Chapter 12 by using iterators to make places in the code clearer and more
concise. Let’s look at how iterators can improve our implementation of the
`Config::build` function and the `search` function.
<!-- stay:gqOvJFKw hash=sha256:9c0f982af5dc -->

### Removing a `clone` Using an Iterator
<!-- stay:aXzKfF18 hash=sha256:e956aea23a88 -->
...
values.
<!-- stay:wF4rp9BG hash=sha256:b23952fa4542 -->
...
<!-- stay:7GrKdFw6 hash=sha256:ea72a710d9a3 -->

Once `Config::build` takes ownership of the iterator and stops using indexing
operations that borrow, we can move the `String` values from the iterator into
`Config` rather than calling `clone` and making a new allocation.
<!-- stay:A2bojiB1 hash=sha256:1e9c79631e05 -->

#### Using the Returned Iterator Directly
<!-- stay:OA08QF21 hash=sha256:a8ef1456ff1a -->

Open your I/O project’s _src/main.rs_ file, which should look like this:
<!-- stay:kc5yBGex hash=sha256:0ce4e7af81d7 -->

<span class="filename">Filename: src/main.rs</span>
<!-- stay:EXdm7ugv hash=sha256:ebb0dc5db82a -->

```rust,ignore
{{#rustdoc_include ../listings/ch13-functional-features/listing-12-24-reproduced/src/main.rs:ch13}}
```
<!-- stay:niNCtTcH hash=sha256:224db637ccc6 -->
...
<!-- stay:cDg5dJpq hash=sha256:18eb1fbd8cc1 -->

<Listing number="13-19" file-name="src/main.rs" caption="Updating the signature of `Config::build` to expect an iterator">
<!-- stay:aDbRHcHQ hash=sha256:291e509cecca -->

```rust,ignore,does_not_compile
{{#rustdoc_include ../listings/ch13-functional-features/listing-13-19/src/main.rs:here}}
```
<!-- stay:KBzZPuCQ hash=sha256:5de90d28222d -->

</Listing>
<!-- stay:WzOdAWSv hash=sha256:b58d16a1f9c0 -->

The standard library documentation for the `env::args` function shows that the
type of the iterator it returns is `std::env::Args`, and that type implements
the `Iterator` trait and returns `String` values.
<!-- stay:u2Ze5nmx hash=sha256:30ba6b987b1c -->
...
<!-- stay:Yt1EFevo hash=sha256:d4646ab3cc6c -->

Because we’re taking ownership of `args` and we’ll be mutating `args` by
iterating over it, we can add the `mut` keyword into the specification of the
`args` parameter to make it mutable.
<!-- stay:5ZssiIHF hash=sha256:d4f5589f931c -->

<!-- Old headings. Do not remove or links may break. -->
<!-- stay:LXsmGJcU hash=sha256:5c2d65695c1a -->

<a id="using-iterator-trait-methods-instead-of-indexing"></a>
<!-- stay:J3FR0F98 hash=sha256:5cdda7eccb83 -->

#### Using `Iterator` Trait Methods
<!-- stay:YpVc9c3m hash=sha256:ba4a0ec3aca2 -->

Next, we’ll fix the body of `Config::build`. Because `args` implements the
`Iterator` trait, we know we can call the `next` method on it! Listing 13-20
updates the code from Listing 12-23 to use the `next` method.
<!-- stay:Vgk0RUB1 hash=sha256:601447eacb3b -->

<Listing number="13-20" file-name="src/main.rs" caption="Changing the body of `Config::build` to use iterator methods">
<!-- stay:5FvLiGkL hash=sha256:615f89f075e6 -->

```rust,ignore,noplayground
{{#rustdoc_include ../listings/ch13-functional-features/listing-13-20/src/main.rs:here}}
```
<!-- stay:pTpp2O0c hash=sha256:83dfc93c29d1 -->

</Listing>
<!-- stay:4mdy6Vfl hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:GayHFGJq hash=sha256:543c52c5a7b8 -->

<!-- Old headings. Do not remove or links may break. -->
<!-- stay:a2oS9bQV hash=sha256:5c2d65695c1a -->

<a id="making-code-clearer-with-iterator-adapters"></a>
<!-- stay:xrdCGI7l hash=sha256:e0cf826ea9dd -->

### Clarifying Code with Iterator Adapters
<!-- stay:CCDOA1zR hash=sha256:752fe63ce092 -->

We can also take advantage of iterators in the `search` function in our I/O
project, which is reproduced here in Listing 13-21 as it was in Listing 12-19.
<!-- stay:UHndlSQW hash=sha256:9c41d2fb50d1 -->

<Listing number="13-21" file-name="src/lib.rs" caption="The implementation of the `search` function from Listing 12-19">
<!-- stay:EjvMThLN hash=sha256:54e0abb358af -->

```rust,ignore
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-19/src/lib.rs:ch13}}
```
<!-- stay:81gEslht hash=sha256:a71bcfe0b486 -->

</Listing>
<!-- stay:HAmsduni hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:gLkWa8Fe hash=sha256:561a6de1aa28 -->
...
<!-- stay:niIbnak0 hash=sha256:9d0ec3fa1eeb -->

```rust,ignore
{{#rustdoc_include ../listings/ch13-functional-features/listing-13-22/src/lib.rs:here}}
```
<!-- stay:ceDMjXZs hash=sha256:8705e7d0e82c -->

</Listing>
<!-- stay:UyiD1VRB hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:Ij03N392 hash=sha256:c7a270561a3b -->
...
<!-- stay:dVB4Jz3P hash=sha256:6e5be69e1da5 -->

<!-- Old headings. Do not remove or links may break. -->
<!-- stay:ihAMQRW3 hash=sha256:5c2d65695c1a -->

<a id="choosing-between-loops-or-iterators"></a>
<!-- stay:PAO3ZHeB hash=sha256:e0df5a3703ca -->

### Choosing Between Loops and Iterators
<!-- stay:WJOjeOBR hash=sha256:6a95de884224 -->
...
<!-- stay:HyeQEnEW hash=sha256:be2819b57b98 -->

But are the two implementations truly equivalent? The intuitive assumption
might be that the lower-level loop will be faster. Let’s talk about performance.
<!-- stay:9YUMMTo6 hash=sha256:71b9487aeab2 -->

[impl-trait]: ch10-02-traits.html#traits-as-parameters
<!-- stay:1C8hKkb9 hash=sha256:d3d8d1401901 -->
