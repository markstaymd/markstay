...
<!-- stay:9jCKpHyU hash=sha256:395f1a9bb372 -->
...
<!-- stay:uv3Zp4XQ hash=sha256:b1fcc2d8f9fe -->
...
directories:
<!-- stay:oSMrGJUp hash=sha256:1e35e49a5c8f -->
...
└── src
    ...
    └── main.rs
```
<!-- stay:Wt6SMKEL hash=sha256:c1f8716bb576 -->

The crate root file in this case is _src/main.rs_, and it contains:
<!-- stay:b2ENXCYH hash=sha256:f136b8bfa54a -->

<Listing file-name="src/main.rs">
<!-- stay:JCRuQuYn hash=sha256:1141968a98b1 -->

```rust,noplayground,ignore
{{#rustdoc_include ../listings/ch07-managing-growing-projects/quick-reference-example/src/main.rs}}
```
<!-- stay:ElItDxli hash=sha256:8687f82b240e -->

</Listing>
<!-- stay:B0wbRaQx hash=sha256:b58d16a1f9c0 -->

The `pub mod garden;` line tells the compiler to include the code it finds in
_src/garden.rs_, which is:
<!-- stay:1X3S04kw hash=sha256:e2008a5927da -->

<Listing file-name="src/garden.rs">
<!-- stay:4FQnoI0p hash=sha256:4c84a6a23a46 -->

```rust,noplayground,ignore
{{#rustdoc_include ../listings/ch07-managing-growing-projects/quick-reference-example/src/garden.rs}}
```
<!-- stay:kIBeGK2V hash=sha256:251ec817b9f0 -->

</Listing>
<!-- stay:9WE6Ayym hash=sha256:b58d16a1f9c0 -->

Here, `pub mod vegetables;` means the code in _src/garden/vegetables.rs_ is
included too. That code is:
<!-- stay:NQ67ee33 hash=sha256:38445b58c9a9 -->

```rust,noplayground,ignore
{{#rustdoc_include ../listings/ch07-managing-growing-projects/quick-reference-example/src/garden/vegetables.rs}}
```
<!-- stay:YwkYVpDn hash=sha256:2cc7a0d64f59 -->

Now let’s get into the details of these rules and demonstrate them in action!
<!-- stay:AxU8MlUy hash=sha256:282be4c5df45 -->

### Grouping Related Code in Modules
<!-- stay:0dYKL80p hash=sha256:34ee8895bfc6 -->
...
on them.
<!-- stay:DsI91mkE hash=sha256:30f647fbe5f6 -->

As an example, let’s write a library crate that provides the functionality of a
restaurant. We’ll define the signatures of functions but leave their bodies
empty to concentrate on the organization of the code rather than the
implementation of a restaurant.
<!-- stay:LpJ125it hash=sha256:3b64449f945b -->
...
work.
<!-- stay:bVsfRHfb hash=sha256:8f32cd73abde -->
...
section.
<!-- stay:2ScNWAq9 hash=sha256:4189582fb0b4 -->
...
<!-- stay:z2qpXTCI hash=sha256:3a8ced4c5b07 -->

```rust,noplayground
{{#rustdoc_include ../listings/ch07-managing-growing-projects/listing-07-01/src/lib.rs}}
```
<!-- stay:sSa3Afi7 hash=sha256:6a600d4268bd -->

</Listing>
<!-- stay:0pIcNFVz hash=sha256:b58d16a1f9c0 -->
...
functions.
<!-- stay:TrxZlRRc hash=sha256:4ce01da608c1 -->
...
<!-- stay:zXjagihE hash=sha256:8479a0c5de13 -->
...
<!-- stay:62NzqEnB hash=sha256:443486f9f004 -->

Listing 7-2 shows the module tree for the structure in Listing 7-1.
<!-- stay:Cfv3U7LM hash=sha256:e7309ddf0b0e -->

<Listing number="7-2" caption="The module tree for the code in Listing 7-1">
<!-- stay:cZuCnoDv hash=sha256:7bd1e6012cb6 -->
...
crate
 └── front_of_house
     ...
     └── serving
         ...
         └── take_payment
```
<!-- stay:VstmKtYG hash=sha256:fbc38825a30b -->

</Listing>
<!-- stay:7kERkP2P hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:lVuA0Io6 hash=sha256:68c3a4909d4f -->

The module tree might remind you of the filesystem’s directory tree on your
computer; this is a very apt comparison! Just like directories in a filesystem,
you use modules to organize your code. And just like files in a directory, we
need a way to find our modules.
<!-- stay:4HybfrEE hash=sha256:cc421fea8840 -->
