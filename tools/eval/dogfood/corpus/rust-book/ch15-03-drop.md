...
<!-- stay:utXlIAvd hash=sha256:fc188296ec49 -->
...
<!-- stay:cJaR3i4n hash=sha256:30a128ab3fa1 -->

```rust
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-14/src/main.rs}}
```
<!-- stay:UX7AJvhB hash=sha256:d924af887f24 -->

</Listing>
<!-- stay:1Sbxdroa hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:ZRYNxc6s hash=sha256:b58cf9c41fc3 -->
...
<!-- stay:fQRHGMUZ hash=sha256:57b9db26652c -->

When we run this program, we’ll see the following output:
<!-- stay:fPouQkqS hash=sha256:5d233c3f90b7 -->

```console
{{#include ../listings/ch15-smart-pointers/listing-15-14/output.txt}}
```
<!-- stay:6IUD91k2 hash=sha256:56ca6da0e937 -->
...
message.
<!-- stay:lQRNXOTb hash=sha256:f201396d1dfa -->

<!-- Old headings. Do not remove or links may break. -->
<!-- stay:GaeaJn29 hash=sha256:5c2d65695c1a -->

<a id="dropping-a-value-early-with-std-mem-drop"></a>
<!-- stay:LxpfokHO hash=sha256:9b1a0f60c294 -->
...
<!-- stay:ttZa8tte hash=sha256:bd6f5533b679 -->
...
<!-- stay:li1RtyWL hash=sha256:9097dde85bc1 -->
...
<!-- stay:iFqAtm1a hash=sha256:62abc873366a -->

```rust,ignore,does_not_compile
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-15/src/main.rs:here}}
```
<!-- stay:K42BU891 hash=sha256:781d89fe8861 -->

</Listing>
<!-- stay:KSFu8sRA hash=sha256:b58d16a1f9c0 -->

When we try to compile this code, we’ll get this error:
<!-- stay:ncZFFaEu hash=sha256:e2b7ba303da4 -->

```console
{{#include ../listings/ch15-smart-pointers/listing-15-15/output.txt}}
```
<!-- stay:2DyRVRb0 hash=sha256:b49367d3381b -->
...
<!-- stay:vHEnWjUs hash=sha256:fc9faf27c45a -->
...
<!-- stay:QrYiDHSX hash=sha256:fec73e7c54a4 -->
...
<!-- stay:qnLRUDAT hash=sha256:d2de77fe4a5f -->

```rust
{{#rustdoc_include ../listings/ch15-smart-pointers/listing-15-16/src/main.rs:here}}
```
<!-- stay:AwEaup30 hash=sha256:1f77e0df49a3 -->

</Listing>
<!-- stay:8XbjCYNo hash=sha256:b58d16a1f9c0 -->

Running this code will print the following:
<!-- stay:d4WXfcJg hash=sha256:9491953a0b33 -->

```console
{{#include ../listings/ch15-smart-pointers/listing-15-16/output.txt}}
```
<!-- stay:XJSqh4Hl hash=sha256:9e4db315ba3b -->
...
`c` at that point.
<!-- stay:tj1ib2uG hash=sha256:59d0d1ab14d2 -->

You can use code specified in a `Drop` trait implementation in many ways to
make cleanup convenient and safe: For instance, you could use it to create your
own memory allocator! With the `Drop` trait and Rust’s ownership system, you
don’t have to remember to clean up, because Rust does it automatically.
<!-- stay:1SpvLL6S hash=sha256:d9d265ea738d -->

You also don’t have to worry about problems resulting from accidentally
cleaning up values still in use: The ownership system that makes sure
references are always valid also ensures that `drop` gets called only once when
the value is no longer being used.
<!-- stay:SC69Nriq hash=sha256:76d75a54f288 -->

Now that we’ve examined `Box<T>` and some of the characteristics of smart
pointers, let’s look at a few other smart pointers defined in the standard
library.
<!-- stay:Svy8AhpM hash=sha256:9997b829b560 -->
