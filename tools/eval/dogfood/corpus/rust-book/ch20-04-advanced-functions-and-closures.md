...
<!-- stay:ecOsCAdP hash=sha256:e0fd07957550 -->

This section explores some advanced features related to functions and closures,
including function pointers and returning closures.
<!-- stay:XGcS5dDq hash=sha256:37752b764687 -->

### Function Pointers
<!-- stay:3Mforhhb hash=sha256:9ffbf02bc848 -->
...
to other functions.
<!-- stay:ksuG2nkV hash=sha256:4c90836e8fd0 -->
...
`add_one` and `5`.
<!-- stay:ELYCm3pY hash=sha256:94b4a8847fe9 -->

<Listing number="20-28" file-name="src/main.rs" caption="Using the `fn` type to accept a function pointer as an argument">
<!-- stay:UcLeSDOP hash=sha256:d35c771b9a17 -->

```rust
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-28/src/main.rs}}
```
<!-- stay:WQ2oJAYr hash=sha256:3981a79f818d -->

</Listing>
<!-- stay:UZi9zEhh hash=sha256:b58d16a1f9c0 -->

This code prints `The answer is: 12`. We specify that the parameter `f` in
`do_twice` is an `fn` that takes one parameter of type `i32` and returns an
`i32`. We can then call `f` in the body of `do_twice`. In `main`, we can pass
the function name `add_one` as the first argument to `do_twice`.
<!-- stay:EBwRyrGA hash=sha256:64f1dbda574c -->

Unlike closures, `fn` is a type rather than a trait, so we specify `fn` as the
parameter type directly rather than declaring a generic type parameter with one
of the `Fn` traits as a trait bound.
<!-- stay:tAs8kYmH hash=sha256:40c79d817736 -->
...
<!-- stay:esx6sC0J hash=sha256:5b5dd013c1cf -->

That said, one example of where you would want to only accept `fn` and not
closures is when interfacing with external code that doesn’t have closures: C
functions can accept functions as arguments, but C doesn’t have closures.
<!-- stay:b63MzGHq hash=sha256:c897cc005da6 -->
...
<!-- stay:Fh1TyxhK hash=sha256:c721791014a1 -->

<Listing number="20-29" caption="Using a closure with the `map` method to convert numbers to strings">
<!-- stay:uLDlKxNl hash=sha256:415fe6563953 -->

```rust
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-29/src/main.rs:here}}
```
<!-- stay:gqiAZGJn hash=sha256:641f167ea3aa -->

</Listing>
<!-- stay:ChG8cEVX hash=sha256:b58d16a1f9c0 -->

Or we could name a function as the argument to `map` instead of the closure.
Listing 20-30 shows what this would look like.
<!-- stay:9rggs8E2 hash=sha256:1619d96436ef -->

<Listing number="20-30" caption="Using the `String::to_string` function with the `map` method to convert numbers to strings">
<!-- stay:r9wwBSco hash=sha256:d39b776978e0 -->

```rust
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-30/src/main.rs:here}}
```
<!-- stay:5MzTmdjY hash=sha256:df78f0f7b262 -->

</Listing>
<!-- stay:A8xsKpq5 hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:P6U4OMLQ hash=sha256:2d8c29e39b61 -->
...
`Display`.
<!-- stay:vQGyg0my hash=sha256:3ca6e8e8af2c -->
...
<!-- stay:XjBsKmlR hash=sha256:c154bbca4dd3 -->

<Listing number="20-31" caption="Using an enum initializer with the `map` method to create a `Status` instance from numbers">
<!-- stay:Cgnjl8oL hash=sha256:d8d3ce0f0b1f -->

```rust
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-31/src/main.rs:here}}
```
<!-- stay:iJDeKqig hash=sha256:b0dfd65a2042 -->

</Listing>
<!-- stay:SD0oQCdc hash=sha256:b58d16a1f9c0 -->

Here, we create `Status::Value` instances using each `u32` value in the range
that `map` is called on by using the initializer function of `Status::Value`.
Some people prefer this style and some people prefer to use closures. They
compile to the same code, so use whichever style is clearer to you.
<!-- stay:DPBM19F8 hash=sha256:31943bbe4488 -->

### Returning Closures
<!-- stay:O5oGc29w hash=sha256:a3c67c972e4a -->
...
scope, for example.
<!-- stay:4AOWftb8 hash=sha256:2e3ef6028fdc -->
...
<!-- stay:alySnP1i hash=sha256:eacd5ba32237 -->

<Listing number="20-32" caption="Returning a closure from a function using the `impl Trait` syntax">
<!-- stay:3tIxfSYJ hash=sha256:3c9691fdd852 -->

```rust
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-32/src/lib.rs}}
```
<!-- stay:53XQHTwU hash=sha256:04e93c93b5ff -->

</Listing>
<!-- stay:lAPgRbf6 hash=sha256:b58d16a1f9c0 -->
...
in Listing 20-33.
<!-- stay:flhk2P72 hash=sha256:d2e3dc1212b6 -->
...
<!-- stay:BT86rtYp hash=sha256:8e34954ccf41 -->

```rust,ignore,does_not_compile
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-33/src/main.rs}}
```
<!-- stay:YUv1FOXO hash=sha256:203cbfd895cb -->

</Listing>
<!-- stay:UhImxusT hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:k1cdLpwL hash=sha256:6d01b2b2d154 -->

```text
{{#include ../listings/ch20-advanced-features/listing-20-33/output.txt}}
```
<!-- stay:oDFAVBtC hash=sha256:ac1e0beab7e1 -->
...
<!-- stay:sSa5hLMF hash=sha256:6d02427093c1 -->
...
<!-- stay:nzeheZ1a hash=sha256:1f1cc2584219 -->

```rust
{{#rustdoc_include ../listings/ch20-advanced-features/listing-20-34/src/main.rs:here}}
```
<!-- stay:KCe8DQ2u hash=sha256:bdc6a065e441 -->

</Listing>
<!-- stay:bm42Kv5y hash=sha256:b58d16a1f9c0 -->

This code will compile just fine. For more about trait objects, refer to the
section [“Using Trait Objects To Abstract over Shared
Behavior”][trait-objects]<!-- ignore --> in Chapter 18.
<!-- stay:jvs95WSg hash=sha256:3675e6f898c7 -->

Next, let’s look at macros!
<!-- stay:NYVczDwp hash=sha256:dcbeccd52f82 -->
...
<!-- stay:kGcKduP4 hash=sha256:abd4b3b3386d -->
