...
<!-- stay:WaJJpSKW hash=sha256:40b98b5325ea -->

Let’s create a new project with, as always, `cargo new`. We’ll call our project
`minigrep` to distinguish it from the `grep` tool that you might already have
on your system:
<!-- stay:fDF2WVk0 hash=sha256:73a66a792d5a -->
...
$ cd minigrep
```
<!-- stay:XHODrk1Y hash=sha256:1a26b7346391 -->
...
<!-- stay:jFNm7TAn hash=sha256:45e3eb21bc3f -->

```console
$ cargo run -- searchstring example-filename.txt
```
<!-- stay:dY92BP2n hash=sha256:f5788cefca31 -->

Right now, the program generated by `cargo new` cannot process arguments we
give it. Some existing libraries on [crates.io](https://crates.io/) can help
with writing a program that accepts command line arguments, but because you’re
just learning this concept, let’s implement this capability ourselves.
<!-- stay:gon6tETP hash=sha256:ee2cc5ff092c -->

### Reading the Argument Values
<!-- stay:620Uj6oh hash=sha256:f470951cdd66 -->
...
<!-- stay:qsHIaA7s hash=sha256:dafdaf93ea0d -->
...
<!-- stay:GtMY1aY0 hash=sha256:d0f2ddd0875c -->

<Listing number="12-1" file-name="src/main.rs" caption="Collecting the command line arguments into a vector and printing them">
<!-- stay:zrQmBjlY hash=sha256:22ee9d4453d2 -->

```rust
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-01/src/main.rs}}
```
<!-- stay:EQJXoevK hash=sha256:7490b749dd71 -->

</Listing>
<!-- stay:ShordRaX hash=sha256:b58d16a1f9c0 -->
...
<!-- stay:9p6QDrcX hash=sha256:b6613c2b1eeb -->
...
<!-- stay:ZszrcQR6 hash=sha256:d59bec92ca49 -->
...
<!-- stay:OPURngYj hash=sha256:5214033c2e7f -->
...
<!-- stay:Yx5OdzO7 hash=sha256:0e84a5daed2f -->

```console
{{#include ../listings/ch12-an-io-project/listing-12-01/output.txt}}
```
<!-- stay:fxybXjo8 hash=sha256:8378ae0a1068 -->

```console
{{#include ../listings/ch12-an-io-project/output-only-01-with-args/output.txt}}
```
<!-- stay:xZYjElut hash=sha256:2a55410ced09 -->
...
<!-- stay:AIWU5ViN hash=sha256:88b766d705c3 -->

### Saving the Argument Values in Variables
<!-- stay:MLWFmaBK hash=sha256:5d7e1c508fbd -->
...
Listing 12-2.
<!-- stay:FC5rAtXQ hash=sha256:8af164c9160e -->

<Listing number="12-2" file-name="src/main.rs" caption="Creating variables to hold the query argument and file path argument">
<!-- stay:0jLQ4osL hash=sha256:e5fc6c11a88d -->

```rust,should_panic,noplayground
{{#rustdoc_include ../listings/ch12-an-io-project/listing-12-02/src/main.rs}}
```
<!-- stay:VM7bjRdL hash=sha256:b241c9c8519f -->

</Listing>
<!-- stay:FfLvS5Th hash=sha256:b58d16a1f9c0 -->
...
variable `file_path`.
<!-- stay:lhh5yZDv hash=sha256:42b0a6819fb9 -->

We temporarily print the values of these variables to prove that the code is
working as we intend. Let’s run this program again with the arguments `test`
and `sample.txt`:
<!-- stay:HL89DlaY hash=sha256:e7ce309e856b -->

```console
{{#include ../listings/ch12-an-io-project/listing-12-02/output.txt}}
```
<!-- stay:3abfIii7 hash=sha256:38a0eab641ea -->
...
<!-- stay:dOxIENYr hash=sha256:1bb57db210f3 -->

[ch13]: ch13-00-functional-features.html
[ch7-idiomatic-use]: ch07-04-bringing-paths-into-scope-with-the-use-keyword.html#creating-idiomatic-use-paths
<!-- stay:52uooLQZ hash=sha256:3d3f234db6c9 -->
